    ...
    <div className="mx-auto max-w-4xl px-4 py-8 sm:px-6 sm:py-12">
      ...
      <div className="mb-8 flex items-start justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Manage your RSS feeds, podcasts, and newsletter sources.
          </p>
        </div>
      </div>
      ...
      {feeds.length === 0 ? (
        <div className="rounded-lg border border-dashed border-border bg-secondary/30 px-4 py-12 text-center">
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Add your first feed above or import from an OPML file.
          </p>
        </div>
      ) : (
        <div className="overflow-hidden rounded-lg border border-border">
          {/* Table header */}
          <div className="hidden border-b border-border bg-muted/50 px-4 py-2.5 sm:grid sm:grid-cols-[1fr_100px_80px_100px_140px]">
      ...
      {feeds.length > 0 && (
        <div className="mt-3 text-right text-xs text-muted-foreground">
          {feeds.length} feed{feeds.length !== 1 ? "s" : ""} &middot;{" "}
...
function FeedRow({
  ...
  const typeConfig = TYPE_CONFIG[feed.type as FeedType] ?? TYPE_CONFIG.rss
  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col gap-2 sm:grid sm:grid-cols-[1fr_100px_80px_100px_140px] sm:items-center">
        {/* Feed name + URL */}
        ...
        {/* Last scanned */}
        <div className="text-right text-xs text-muted-foreground sm:text-right">
